...
class SAHIInference:
    ...
    def inference(
        ...
        Args:
            ...
            save_img (bool): Whether to save annotated output frames.
        ...
        while cap.isOpened():
            ...
            if save_img and save_dir is not None:
                ...
                results.export_visuals(
                    export_dir=save_dir, file_name=f"img_{idx}", hide_conf=hide_conf
                )
    ...
    def parse_opt() -> argparse.Namespace:
        ...
        parser.add_argument(
            "--weights", type=str, default="yolo11n.pt", help="initial weights path"
        )
        ...
        parser.add_argument(
            ...
            default=False,
            action="store_true",
            help="display or hide confidences",
        )
        parser.add_argument(
            "--slice-width", default=512, type=int, help="Slice width for inference"
        )
        parser.add_argument(
            "--slice-height", default=512, type=int, help="Slice height for inference"
        )
