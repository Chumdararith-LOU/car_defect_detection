...
class BYTETracker:
    ...
    def update(
        ...
        **kwargs,
        ...
        detections = self.init_track(
            results_high, self._input_for(img, feats, mask_high)
        )
        detections_second = self.init_track(
            results_low, self._input_for(img, feats, mask_low)
        )
        ...
        self._init_new_tracks(
            u_detection, detections, activated_stracks, refind_stracks
        )
    ...
    def _split_detections(
        ...
        return (
            results[remain_inds],
            results[inds_low & inds_below_high],
            remain_inds,
            inds_low & inds_below_high,
        )
