...
MODEL = (
    WEIGHTS_DIR / "path with spaces" / "yolo26n.pt"
)  # path with spaces to test path handling
CFG = "yolo26n.yaml"
...
MODELS = sorted(
    [*list(TASK2MODEL.values()), "yolo11n-grayscale.pt"]
)  # task models plus grayscale variant
SOLUTION_ASSETS = {
